...
```fretboard-grid
{
  ...
  "height": 260,
  "items": [
    { "startFret": 1, "endFret": 5, "notes": [{"fret": 1, "string": 1, "color": "blue", "label": "R"}] },
    { "startFret": 3, "endFret": 7, "notes": [{"fret": 3, "string": 1, "color": "green", "label": "3"}] },
    null,
    { "startFret": 5, "endFret": 9, "notes": [{"fret": 0, "string": 1, "color": "red", "label": "o"}] },
    null,
    null,
    null,
    null,
